...
class Resize(object):
    ...
    def __init__(self, size):
        assert (isinstance(size, collections.abc.Sequence) and len(size) == 2)
        self.size = size
...
class RandScale(object):
    ...
    def __init__(self, scale, aspect_ratio=None):
        ...
        if isinstance(scale, collections.abc.Sequence) and len(scale) == 2 \
        ...
        elif isinstance(aspect_ratio, collections.abc.Sequence) and len(aspect_ratio) == 2 \
...
class RandRotate(object):
    ...
    def __init__(self, rotate, padding, ignore_label=255, p=0.5):
        assert (isinstance(rotate, collections.abc.Sequence) and len(rotate) == 2)
